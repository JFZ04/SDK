...
#undef iconv_open
     ...
     * @return Allocated iconv conversation buffer's pointer.
     */
    extern  iconv_t iconv_open(int tocode_cp, int fromcode_cp, bool strict = true);
...
#undef iconv
     ...
     */
    extern  size_t iconv(iconv_t cd, char **inbuf, size_t *inbytesleft, char **outbuf,
                                       size_t *outbytesleft);
...
#undef iconv_close
     ...
     * @param data Data.
     */
    extern  void iconvlist(int (*do_one)(unsigned int namescount, const char *const *names, void *data),
                                          void *data);
     ...
     */
    extern  int iconv_string(const iconv_t& cd, const char *start,
     ...
     *
     */
    extern  int iconv_string(const char* tocode, const char* fromcode, const char* start,
                                            const char* end, char** resultp, size_t* lengthp);
     ...
     *
     */
    extern  int iconv_string(int tocode_cp, int fromcode_cp, const char* start,
